...
namespace FParsec
{
    ...
    public class Operator<TTerm, TAfterString, TUserState>
    {
        ...
        internal static readonly Operator<TTerm, TAfterString, TUserState> ZeroPrecedenceOperator = new Operator<TTerm, TAfterString, TUserState> { Type = OperatorType.Prefix };
                        ...
                        : OptimizedClosures.FSharpFunc<TAfterString, TTerm, TTerm>
        {
            ...
            public NoAfterStringUnaryMappingAdapter(FSharpFunc<TTerm, TTerm> mapping)
            {
                Mapping = mapping;
            }
                         ...
                         : OptimizedClosures.FSharpFunc<TAfterString, TTerm, TTerm, TTerm>
        {
            ...
            public NoAfterStringBinaryMappingAdapter(OptimizedClosures.FSharpFunc<TTerm, TTerm, TTerm> mapping)
            {
                Mapping = mapping;
            }
    ...
    public sealed class OperatorPrecedenceParser<TTerm, TAfterString, TUserState> : ParserX<TTerm, TUserState>
    {
               ...
               OperatorConflictErrorFormatter
        {
            ...
            set
            {
                _OperatorConflictErrorFormatter = OptimizedClosures.FSharpFunc<Tuple<Position, Operator<TTerm, TAfterString, TUserState>, TAfterString>, Tuple<Position, Operator<TTerm, TAfterString, TUserState>, TAfterString>, ErrorMessageList>
                                                  .Adapt(value);
            }
        }
        ...
        {
            return Remove(OperatorType.Infix, opString);
        }

        public bool RemovePrefixOperator(string opString)
        {
            return Remove(OperatorType.Prefix, opString);
        }

        public bool RemovePostfixOperator(string opString)
        {
            return Remove(OperatorType.Postfix, opString);
        }
        ...
        public IEnumerable<Operator<TTerm, TAfterString, TUserState>> Operators
        {
            get
            {
                                ...
                                CharStream<TUserState> stream)
        {
            ...
            Debug.Assert(ok);
                ...
                CheckNextOp:
                    ...
                    { // op.OperatorType == OperatorType.Postfix
