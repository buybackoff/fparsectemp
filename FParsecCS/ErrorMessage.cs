...
namespace FParsec
{
    ...
    public class ErrorMessage : IEquatable<ErrorMessage>
    {
        ...
        {
            internal static Func<string, ErrorMessage> Factory = s => new Expected(s);
        ...
        {
            internal static Func<string, ErrorMessage> Factory = s => new ExpectedString(s);
        ...
        {
            internal static Func<string, ErrorMessage> Factory = s => new ExpectedCaseInsensitiveString(s);
        ...
        {
            internal static Func<string, ErrorMessage> Factory = s => new Unexpected(s);
        ...
        {
            internal static Func<string, ErrorMessage> Factory = s => new UnexpectedString(s);
        ...
        {
            internal static Func<string, ErrorMessage> Factory = s => new UnexpectedCaseInsensitiveString(s);
        ...
        {
            internal static Func<string, ErrorMessage> Factory = s => new Message(s);
        ...
        {
            internal static Func<object, ErrorMessage> Factory = s => new Other(s);
        ...
        private bool EqualsHelper(ErrorMessage other)
        {
            ...
            { // ErrorMessageType == ErrorMessageType.Other
